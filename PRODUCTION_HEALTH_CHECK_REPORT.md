...
**Backend URL**: https://pizoo-monorepo.preview.emergentagent.com  
...
**URL**: https://pizoo-monorepo.preview.emergentagent.com/  
...
**URL**: https://pizoo-monorepo.preview.emergentagent.com/api/  
**Status**: ✅ **OPERATIONAL**
...
```
Test: OPTIONS https://pizoo-monorepo.preview.emergentagent.com/api/
...
**Evidence**:
```bash
$ curl https://pizoo-monorepo.preview.emergentagent.com/health
...
**Evidence**:
```bash
$ curl -X POST https://pizoo-monorepo.preview.emergentagent.com/api/auth/login \
...
```json
{
  ...
  "backend_url": "https://pizoo-monorepo.preview.emergentagent.com",
  ...
  "services": {
    ...
    "backend_health": {
      "status": "fail",
      "url": "https://pizoo-monorepo.preview.emergentagent.com/health",
      "http_code": 200,

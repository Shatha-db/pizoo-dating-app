...
```bash
# 1. Get usage context
curl -X GET "https://dating-app-bugfix.preview.emergentagent.com/api/usage/context" \
...
# 2. Increment view
curl -X POST "https://dating-app-bugfix.preview.emergentagent.com/api/usage/increment" \
  -H "Authorization: Bearer YOUR_TOKEN" \

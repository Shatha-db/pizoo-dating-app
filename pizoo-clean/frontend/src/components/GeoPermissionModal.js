      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-t-3xl shadow-2xl animate-slide-up">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
            📍 {t('location_permission_title', { ns: 'map' })}
          </h3>
          <button
            onClick={handleClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="text-center space-y-2">
            <p className="text-gray-700 dark:text-gray-300">
              {t('location_permission_description', { ns: 'map' })}
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {t('location_permission_note', { ns: 'map' })}
            </p>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
            <p className="text-xs text-blue-700 dark:text-blue-300">
              🔒 {t('location_privacy_note', { ns: 'map' })}
            </p>
          </div>
